...
def vgg19_model(
    ...
    **kwargs 
    ...
    """
    This function returns a vgg19 transfer learning model
    ...
    Note:
        For VGG19, call tf.keras.applications.vgg19.preprocess_input on 
        your inputs before passing them to the model. vgg19.preprocess_input 
    ...
    tranfer_model_base = tf.keras.applications.vgg19.VGG19(
    ...
    x = tf.keras.applications.vgg19.preprocess_input(inputs) # Preprocess for VGG19
